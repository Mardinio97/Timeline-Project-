...
public class TimelineController implements Initializable {
    ...
    public void setTimeline(Timeline timeline) {
        ...
        if (timeline.getTimeUnit().equals("hour") || timeline.getTimeUnit().equals("Hours")) {
            ...
            startTimelineInt = timeline.getStartInt();
        }

        // MUST BE THE SAME AS CREATE BACKGROUND
        pageTimeUnit = getCalendarTimeUnit(lenght24hours);

        //CALCULATE TIME RATIO (for event length)
        timeRatio = lenght24hours / 86400;
                ...
                public ArrayList<EventThumbnail> call() {
                    ...
                    if (resEvent != null) {
                        ...
                        for (Event event : resEvent) {
                            ...
                            eventThumbnail.createView(timelineController.getTimeRatio(), timeline.isAbsoluteTimeline(),timeline.getTimeUnit());
    ...
    public double calculateHorzPos(long timestampSeconds) {
        if (timelineType.equals("absolute")) {
            ...
            return ((intPageWidth / intPerPage) * timestampSeconds) - 3.0 + offSetStartingTimeGUI - (startTimelineInt * (intPageWidth / intPerPage));
        } else {
            System.err.println("ERROR CALCULATING HORZ POS");
            return 0;
        }
