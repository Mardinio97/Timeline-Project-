...
public class EventThumbnail {
    ...
    public void createView(double timeRatio, boolean absoluteTimeline, String timeUnit) {
        ...
        if(thumbnailTemplate!=null) {
            ...
            if(absoluteTimeline == false) {
                ((Label) thumbnailTemplate.lookup("#EventDescription")).setText(event.getStartInt()+" "+timeUnit);
            } else {
            ...
            if(event.getEndDate()!=null) {
                ...
                timeLenght = timeLenght>0 ? timeLenght : 6.0;
            }
